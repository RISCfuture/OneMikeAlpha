...
class TelemetryParameterPath
  ...
  def inspect = "#<#{self.class} #{head.inspect}>"
  ...
  module Node
    class Base
      ...
      def _inspect = raise(NotImplementedError)
    ...
    class CompositeProperty < Property
      ...
      def inspect = "#{klass}##{property}.#{component}"
    end
    ...
    class Association < Base
      ...
      def _inspect = "#{klass}##{association.name}"
    ...
    class IndexedAssociation < Association
      ...
      def _inspect = "#{association.active_record}##{association.name}[#{index}]"
    end
    ...
    class AnyAssociation < Association
      def _inspect = "#{association.active_record}##{association.name}[any]"
    end
  end
