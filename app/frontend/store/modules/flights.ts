...
const actions = {
  ...
  loadFlights({commit, state}: ActionContext<FlightsState, RootState>, {aircraftID, params}: {aircraftID: string, params: {[name: string]: string}}): Promise<Flight[] | null> {
  ...
  loadFlightsWithIDLowerThan({commit, state, dispatch}: ActionContext<FlightsState, RootState>, {aircraftID, force, filter, ID}: {aircraftID: string, force?: boolean, filter?: string, ID?: number}): Promise<number | null> {
  ...
  loadFlightsWithIDHigherThan({commit, state, dispatch}: ActionContext<FlightsState, RootState>, {aircraftID, force, filter, ID}: {aircraftID: string, force?: boolean, filter?: string, ID?: number}): Promise<number | null> {
