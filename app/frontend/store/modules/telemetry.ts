...
export interface TelemetryResponse {
  ...
  telemetry: Record<string, Datapoint<DatapointValue>[]>
}
...
const mutations = {
  ...
  APPEND_TELEMETRY(state: TelemetryState, {interval, time_range, telemetry}: {interval: number, time_range: TimeRange, telemetry: Record<string, TelemetryDatapoint[]>}) {
