...
export function mergeTelemetry<DatapointType>(telemetry: Map<string, Map<number, DatapointType[]>>, newTelemetry: {[parameter: string]: DatapointType[]}, interval: number, timeRange: TimeRange): Map<string, Map<number, DatapointType[]>> {
